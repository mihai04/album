 ...
 */
final class Version20200105190730 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `review` (id INT AUTO_INCREMENT NOT NULL, reviewer INT NOT NULL, album INT NOT NULL, title VARCHAR(255) NOT NULL, review LONGTEXT NOT NULL, rating VARCHAR(255) NOT NULL, timestamp VARCHAR(255) NOT NULL, INDEX IDX_794381C6E0472730 (reviewer), INDEX IDX_794381C639986E43 (album), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
