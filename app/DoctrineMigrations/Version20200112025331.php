 ...
 */
final class Version20200112025331 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `album` (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, artist VARCHAR(255) NOT NULL, isrc VARCHAR(16) NOT NULL, image VARCHAR(255) DEFAULT NULL, summary LONGTEXT DEFAULT NULL, is_published TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_39986E43F86F9A0A (isrc), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
